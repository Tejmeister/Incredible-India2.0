...
<body data-spy="scroll" data-target=".navbar" data-offset="50">
	<div id="wrapper">
		...
		<div id="Home" class="w3-container w3-mobile">
			<div class="w3-container w3-padding-8 ">
				
				<p class="w3-text-white w3-mobile w3-tangerine w3-margin-bottom" style="margin-top:-80px;"><i><strong>❝If there is one place on the face of earth where all dreams 
			...
			<div id="second" class="w3-container ">
				...
				<div class="w3-col s4">
					...
					<img class="mySlides w3-middle w3-animate-fading w3-mobile w3-row-padding w3-margin-top w3-margin-top w3-mobile" src="home2.jpg" style="width:100%">
					...
					<img class="mySlides w3-middle w3-animate-fading w3-mobile w3-row-padding w3-margin-top w3-margin-top w3-mobile" src="incredible7.jpg" style="width:100%">
				</div>
			...
			<nav class="navbar navbar-inverse w3-opacity-min w3-top w3-mobile" data-spy="affix" data-offset-top="197">
				<div class="container-fluid w3-xlarge w3-black">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="index.php"><img class="w3-ripple w3-margin-right w3-mobile w3-hover-none w3-hover-text-white" src="Logo.jpg"></a>
					</div>
					<div class="collapse navbar-collapse w3-right" id="myNavbar">
						<ul class="nav navbar-nav">
							<li><a href="#Home" class="w3-hover-opacity-off w3-button w3-margin-right w3-ripple w3-text-amber"><i class="fa fa-home"></i>Home</a></li>
							...
							<li class="dropdown">
								<a class="dropdown-toggle w3-hover-opacity-off w3-button w3-margin-right w3-ripple w3-text-amber" data-toggle="dropdown" href="#">Interests<span class="caret"></span></a>
								<ul class="dropdown-menu w3-large">
									<li><a href="#Purpose">Purpose</a></li>
									<li><a href="#Topo">Topography</a></li>
									<li><a href="#Season">Season of Visit</a></li>
								</ul>
							</li>
							<li><a href="upload.php" class="w3-ripple w3-hover-opacity-off w3-button w3-margin-right w3-text-amber ">New Additions</a></li>
							<li><a href="#Footer" class="w3-ripple w3-hover-opacity-off w3-button w3-margin-right w3-text-amber ">Enquire</a></li>
						</ul>
					</div>
				</div>
			</nav>
		</header>
		<a href="javascript:" id="return-to-top"><i class="fa fa-chevron-up w3-top"></i></a>
		<script>
		...
		<section id="Unexplored">
			...
			<div class="post w3-animate-bottom w3-margin w3-card-4 ">
				<div id="Chembra" class="post picture w3-display-container" style="display:none">
				  <a href="review.php?id=56"><img class="w3-mobile" src="Chembra-Lake-in-Meppadi.jpg" alt="Chembra" style="width:100%"></a>
				...
				<div id="Parule" class="picture w3-display-container" style="display:none">
				  <a href="review.php?id=1"><img class="w3-mobile" src="Parule-Bhogwe-in-Maharashtra.jpg" alt="Parule" style="width:100%"></a>
				  <span onclick="this.parentElement.style.display='none'" 
				  class="w3-display-topright w3-button w3-transparent w3-text-white">&times;</span>
				...
				<div id="Gurez" class="picture w3-display-container" style="display:none">
				  <a href="review.php?id=58"><img class="w3-mobile" src="Gurez-Valley-in-Kashmir-2.jpg" alt="Gurez" style="width:100%"></a>
				  <span onclick="this.parentElement.style.display='none'" 
				  class="w3-display-topright w3-button w3-transparent w3-text-white">&times;</span>
				...
				<div id="Lepakshi" class="picture w3-display-container" style="display:none">
				  <a href="review.php?id=57"><img class="w3-mobile" src="Lepakshi-in-Andhra-Pradesh2.jpg" alt="Lepakshi" style="width:100%"></a>
				  <span onclick="this.parentElement.style.display='none'" 
				  class="w3-display-topright w3-button w3-transparent w3-text-white">&times;</span>
				...
				<div id="Damro" class="picture w3-display-container" style="display:none">
				  <a href="review.php?id=2"><img class="w3-mobile" src="Damro-in-Arunachal-Pradesh.jpg" alt="Damro" style="width:100%"></a>
				  <span onclick="this.parentElement.style.display='none'" 
				  class="w3-display-topright w3-button w3-transparent w3-text-white">&times;</span>
				...
				<div id="Chopta" class="picture w3-display-container" style="display:none">
				  <a href="review.php?id=59"><img class="w3-mobile" src="Chopta-in-Uttarakhand.jpg" alt="Chopta" style="width:100%"></a>
				  <span onclick="this.parentElement.style.display='none'" 
				  class="w3-display-topright w3-button w3-transparent w3-text-white">&times;</span>
			...
			<div class="w3-row-padding w3-margin-top">
			  ...
			  <div class="w3-third">
				<div class="w3-card-2 w3-hover-opacity post w3-btn">
				  ...
				  <img class="w3-mobile" src="Gurez-Valley-in-Kashmir-2.jpg" style="width:100%" alt="Gurez">
				  </a>
				  <div class="w3-container">
					<h5>Gurez-Valley</h5>
				  </div>
		...
		<div id="Purpose" class=" w3-container w3-card-4 w3-mobile w3-margin-top">
			...
			<div id="Adventures" class="w3-container w3-border city w3-margin w3-animate-zoom w3-mobile">
							...
							while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
								...
								<div class='w3-col s3 w3-mobile' style='min-height:250px;'>
									<div class='w3-card-2 w3-display-container w3-hover-opacity w3-mobile'>
										<div class='post'>
											<a href='review.php?id=$pid' class='w3-hover-opacity'>
												<img class='imagefine' src='images/$img' id='$pid' alt='$' style='width:100%; max-height:200px' >
											</a>
			...
			<div class="w3-modal-content w3-card-4">
			 <div class="w3-card-4 w3-top w3-margin w3-content w3-text-light-grey w3-dark-grey" >
				...
				<div class="w3-section">
				  <p><i class="fa fa-envelope fa-fw w3-text-light-grey w3-text-xxlarge w3-margin-right"> </i> Email: incredibleIndia@gov.in</p>
				</div><br>
		...
		<div id="Reach" class="container w3-mobile">
			<div class="w3-row-padding w3-margin-top w3-mobile">
					<div class="w3-col s6 w3-left"><img class="w3-mobile" src="logo1.jpg" alt="MP Tourism Logo"></div>
					
					<div class="w3-xlarge w3-center w3-col s6 ">CONNECT WITH US</div>
						<a href="https://www.facebook.com/pages/Incredible-India" target="_blank" class="fa fa-facebook w3-xlarge " onclick="ga('send', 'event', 'Footer', 'Click', 'Facebook - Connect with Us');"></a>
						<a href="https://twitter.com/incredibleindia" target="_blank" class="fa fa-twitter " onclick="ga('send', 'event', 'Footer', 'Click', 'Twitter - Connect with Us');"></a>
						<a href="https://www.youtube.com/channel/UCMxJPchGLE_CJ1MJbJy-xDQ" target="_blank" class="fa fa-youtube  " onclick="ga('send', 'event', 'Footer', 'Click', 'Youtube - Connect with Us');"></a>
						<a href="https://in.pinterest.com/MpTourismDotCom" target="_blank" class="fa fa-pinterest " onclick="ga('send', 'event', 'Footer', 'Click', 'Pinterest - Connect with Us');"></a>
						<a href="https://instagram.com/_incredibleindia" target="_blank" class="fa fa-instagram " onclick="ga('send', 'event', 'Footer', 'Click', 'Instagram - Connect with Us');"></a>
						<br>
						<p class="w3-large w3-mobile">Created By &copy <a href="http://www.google.com" target="_blank" class="w3-hover-text-green">GOVT</a></p>
			</div>
